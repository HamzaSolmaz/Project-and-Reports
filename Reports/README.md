# Reports
## Long-Range Camera-Based Drone Tracking with Laser Alignment
  This project is an autonomous, camera-based system designed to detect drones and continuously track them. Operating on an embedded processor, the system can accurately detect a 30 cm wide drone from a distance of 50 meters. It successfully achieves real-time tracking to maintain laser alignment even when the drone is flying at typical speeds of 3-6 m/s.  
  Final demo: https://youtu.be/ahifvBg3XH4?si=hUiXBTvhXlvD5vGd
